...
# set DOCKER_REGISTRY_AUTH to auth endpoint for private Docker reginstry
DOCKER_REGISTRY_AUTH ?=

.PHONY: test bulid release clean tag buildtag login logout publish

test:
	${INFO} "Working with docker-compose V2..."
	...
	${INFO} "Ensureing database is ready..."
...
release:
	${INFO} "PUlling latest images..."
	${INFO} "Release project ...  $(REL_PROJECT)"
...
buildtag:
	${INFO} "Tagging release image with suffix $(BUILD_TAG) and bulid tags $(BUILDTAG_ARGS)..."
